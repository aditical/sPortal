...
<body>
              ...
              <div class="row">
                <div class="col-md-8">
                  <section class="panel panel-info">
                    <header class="panel-heading font-default">Notice</header>
                    <div class="panel-body">
                      <form class="bs-example form-horizontal" action="noticeform.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <div class="col-lg-offset-2 col-lg-10">
                            <button type="submit" class="btn btn-sm btn-info" name="done">Submit</button>
                          </div>
                        </div>
                      </form>
                    </div>
  ...
  <?php
	...
	if(isset($_POST['done'])){
		if ($_POST['title']=='' or $_POST['author']==''){
			...
			$date=date('y.m.d');
			$query="insert into notices(batch,title,author,description,files,date) values ('$batch','$title','$author','$description','$fileNewName','$date')";
